...
export const ORDER_DEIVER_REQUEST = 'ORDER_DEIVER_REQUEST';
export const ORDER_DEIVER_SUCCESS = 'ORDER_DEIVER_SUCCESS';
export const ORDER_DEIVER_FAIL = 'ORDER_DEIVER_FAIL';
export const ORDER_DEIVER_RESET = 'ORDER_DEIVER_RESET';
